  ...
  return (
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2 bg-accent/10 rounded-lg p-1 shadow-lg">
          {
            THEMES.map((Theme, ThemeIndex) => (
              <button
                key={ThemeIndex}
                className={`group flex flex-col items-center gap-1.5 p-2 rounded-lg transition-colors ${theme === Theme ? "bg-base-300" : "hover:bg-base-200/50"}`}
      ...
      <div className="rounded-lg overflow-hidden bg-base-100 shadow-lg">
            ...
            <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
              ...
              <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-sm">Samius Sazin</h3>
